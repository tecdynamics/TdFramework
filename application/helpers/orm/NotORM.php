...
* @$debug false Enable debugging queries, true for error_log($query), callback($query, $parameters) otherwise
 ...
 *@example  description Else please check all the test functions in the /application/helpers/orm/tests/
*/
